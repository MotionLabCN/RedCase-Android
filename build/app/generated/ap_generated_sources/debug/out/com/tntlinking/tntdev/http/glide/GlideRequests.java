package com.tntlinking.tntdev.http.glide;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.tntlinking.tntdev.http.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.tntlinking.tntdev.http.glide.GlideOptions().apply(toSet));
    }
  }
}
