...
//
//    public GetFirmPositionListApi setStatus(int status) {
//        this.status = status;
//        return this;
//    }
//
//    public GetFirmPositionListApi setPageNum(int pageNum) {
//        this.pageNum = pageNum;
//        return this;
//    }
//
//    public GetFirmPositionListApi setPageSize(int pageSize) {
