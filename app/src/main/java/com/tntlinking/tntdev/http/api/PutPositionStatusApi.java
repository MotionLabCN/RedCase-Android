...
//获取开发者列表
public final class PutPositionStatusApi implements IRequestApi {

    @Override
    public String getApi() {
        return "manpower-rest-api/position/status";
    }


    private int positionId;
    private int status;//0关1开


    public PutPositionStatusApi setPositionId(int positionId) {
        this.positionId = positionId;
        return this;
    }

    public PutPositionStatusApi setStatus(int status) {
        this.status = status;
        return this;
    }
