...
//APP端职位列表(分页)
public final class GetFirmRecommendsApi implements IRequestApi {
    ...
    public GetFirmRecommendsApi setPageNum(int pageNum) {
        this.pageNum = pageNum;
        return this;
    }

    public GetFirmRecommendsApi setPageSize(int pageSize) {
