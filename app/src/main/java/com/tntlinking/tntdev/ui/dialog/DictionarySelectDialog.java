...
public final class DictionarySelectDialog {
    ...
    public static final class Builder extends BaseDialog.Builder<Builder> {
        ...
        public Builder(Context context) {
            ...
            mRecycleview = findViewById(R.id.rv_time_hour);

            mAdapter = new PickerAdapter(context);
//            ArrayList<String> hourData = new ArrayList<>();
//            hourData.add("男");
//            hourData.add("女");
//            mAdapter.setData(hourData);
            ...
            mRecycleview.setLayoutManager(mHourManager);
...
//            mHourView.addOnLayoutChangeListener(this);
    ...
    private static final class PickerAdapter extends AppAdapter<GetDictionaryApi.DictionaryBean> {
