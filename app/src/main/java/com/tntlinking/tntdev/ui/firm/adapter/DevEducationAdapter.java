...
public final class DevEducationAdapter extends BaseAdapter {

    private List<DeveloperInfoBean.DeveloperEducation> mList;
    private LayoutInflater layoutInflater;

    public DevEducationAdapter(Context context, List<DeveloperInfoBean.DeveloperEducation> list) {
        this.mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.item_dev_education, null);
