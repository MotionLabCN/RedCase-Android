...
public final class DevProjectAdapter extends BaseAdapter {

    private List<DeveloperInfoBean.DeveloperProject> mList;
    private LayoutInflater layoutInflater;
    private Context mContext;

    public DevProjectAdapter(Context context, List<DeveloperInfoBean.DeveloperProject> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.item_dev_project, null);
