 ...
 */
public class TagSelectedAdapter<T> extends BaseAdapter implements FlowTagLayout.OnInitSelectedPosition {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.tag_selected_item, null);
