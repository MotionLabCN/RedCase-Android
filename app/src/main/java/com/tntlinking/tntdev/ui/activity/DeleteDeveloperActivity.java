...
public final class DeleteDeveloperActivity extends AppActivity {
    ...
    public void onClick(View view) {
        if (view == mCommitView) {
            new BaseDialog.Builder<>(DeleteDeveloperActivity.this)
                ...
                .request(new HttpCallback<HttpData<List<GetCancellationApi.ListBean>>>(this) {
                    ...
                    public void onSucceed(HttpData<List<GetCancellationApi.ListBean>> data) {
                        if (data.getData().size() != 0) {
                            ...
                            mAdapter = new CancelServiceAdapter(DeleteDeveloperActivity.this, data.getData());
        ...
        EasyHttp.post(this)
                ...
                .request(new HttpCallback<HttpData<Void>>(this) {
                    ...
                    public void onSucceed(HttpData<Void> data) {
                        Intent intent = new Intent(DeleteDeveloperActivity.this, SignStatusActivity.class);
